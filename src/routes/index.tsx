  ...
  return (
    <>
      <div className="flex flex-col h-[calc(100vh-60px)]">
        <SkillTreeDisplay />
        <div className="md:absolute md:left-0 flex md:ml-2 md:mt-2 h-auto md:max-h-8/12 md:w-87.5 md:rounded bg-[#1b1612] text-white border border-[#736559] shadow-xl">
          <SearchBox />
        </div>
